...
<footer style={{backgroundImage: 'url(https://www.radiustheme.com/demo/wordpress/themes/homlisti/wp-content/themes/homlisti/assets/img/footer-2-bg.jpg)'}}  className=" bg-cover px-5 bg-no-repeat">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white dark:hover:text-white ms-5">
